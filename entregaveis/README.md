...
— só para leitura mais confortável, o conteúdo é o mesmo do `.md`. O GitHub
exibe `.html` como código-fonte bruto, então a coluna "Leitura" abre a versão
renderizada via [htmlpreview.github.io](https://htmlpreview.github.io/).

| # | Entregável | Arquivo | Leitura |
|---|---|---|---|
| 1 | Diagrama da arquitetura | [`01-diagrama-arquitetura.md`](01-diagrama-arquitetura.md) | [HTML](https://htmlpreview.github.io/?https://raw.githubusercontent.com/ShirleiAlexandrino/case-impulsogov/main/entregaveis/apresentacao/diagrama-arquitetura.html) · [offline](https://htmlpreview.github.io/?https://raw.githubusercontent.com/ShirleiAlexandrino/case-impulsogov/main/entregaveis/apresentacao/diagrama-arquitetura-offline.html) |
...
| 5 | Nota sobre uso de IA (obrigatória) | [`05-nota-uso-ia.md`](05-nota-uso-ia.md) | [HTML](https://htmlpreview.github.io/?https://raw.githubusercontent.com/ShirleiAlexandrino/case-impulsogov/main/entregaveis/apresentacao/nota-uso-ia.html) |

O que passa daqui é além do pedido no case — está em [`../extras/`](../extras/)
(notas de LGPD) e no app Streamlit ([`../app.py`](../app.py)), não faz parte
dos cinco itens acima.
